...
export const twVariant: { bg: TwVariantObject; border: TwVariantObject } = {
  bg: {
    ...
    solid: tw`bg-success text-white hover:bg-opacity-80`,
    twoTone: tw`bg-danger text-white hover:bg-opacity-80`,
  ...
  border: {
    ...
    solid: tw`border-2 border-success text-success hover:(border-opacity-80 text-opacity-80)`,
    twoTone: tw`border-2 border-danger text-danger hover:(border-opacity-80 text-opacity-80)`,
